...
namespace ProgrammingProblems
{
    ...
    public static class LeetCode
    {
        ...
        ///     0 <= val <= 100
        /// 
        /// Proposed Solution: Traverse array to find elements with an equal value to val. Use a head and tail variables to swap elements of the array.
        /// Do this until head and tail values are the same.
        /// </summary>
        /// <returns>Return an integer k after placing the final result in the first k slots of array nums.</returns>
        public static int RemoveElement(int[] nums, int val)
        {
            return ArrayExtension.RemoveElement(nums, val);
        }
    }
}
